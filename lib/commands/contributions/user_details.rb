...
def print_details(logger, start_date, end_date, user_contributions)
...
def user_details(db, logger, start_date, end_date, uname, name)
  unless uname.nil?
  ...
  unless user_contributions.nil?
    print_details(logger, start_date, end_date, user_contributions)
  end
end